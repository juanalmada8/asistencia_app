...
def generar_resumen_asistencia(sheet_id):
    import pandas as pd
    ...
    # Función auxiliar para pegar DataFrames
...
if st.button("📊 Generar resumen de asistencia"):
    generar_resumen_asistencia(sheet_id="1MIzfkUB9kOsHyvNKVfBcS0VzmGbJnE4w8ufnvxHd5Po")